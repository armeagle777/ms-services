export const FormatFilterWpPersonsBaseQuery = `SELECT ALL_PERSON.tablename, ALL_PERSON.id, ALL_PERSON.passport_number, ALL_PERSON.citizenship_id, ALL_PERSON.ssn, ALL_PERSON.alpha_3, ALL_PERSON.arm_short, ALL_PERSON.first_name_en, ALL_PERSON.last_name_en,ALL_PERSON.serial_number, ALL_PERSON.issue_date, ALL_PERSON.expire_date, ALL_PERSON.card_status, 
