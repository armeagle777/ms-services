...
import { SEARCH_BASES } from 'src/Core/Kadastr/kadastr.constants';
import { KadastrProperty } from 'src/Core/Kadastr/interfaces/kadastr.interfaces';
...
export class KadastrService {
   ...
   private loadCertificates() {
      const keyPath =
         this.configService.get<string>('KADASTR_KEY_PATH') ||
         './src/certificates/migration_am.key';
      const certPath =
